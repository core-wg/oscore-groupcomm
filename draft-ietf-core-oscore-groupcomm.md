...
* Security group, as defined in {{terminology}} of this document. Between security groups and application groups, there can be a many-to-many, one-to-many, many-to-one, or one-to-one relationship.
