...
It is recommended that the join process adopts the approach described in {{I-D.ietf-ace-key-groupcomm-oscore}}, which is based on the ACE framework for Authentication and Authorization in constrained environments {{I-D.ietf-ace-oauth-authz}}. 
