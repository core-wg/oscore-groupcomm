...
After receiving a 4.01 (Unauthorized) response that includes an Echo Option and originates from a verified group member, a subsequently sent client request echoing the Echo Option value MUST be sent as a unicast message to the same server.
